-- Lyrics AI Migration - Uses existing beat_sessions table
-- Created: 2024-12-20

-- Add lyrics AI specific columns to existing beat_sessions table
...
CREATE INDEX IF NOT EXISTS idx_beat_sessions_lyrics_user_id ON beat_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_beat_sessions_lyrics_content_type ON beat_sessions(lyrics_content_type);
CREATE INDEX IF NOT EXISTS idx_beat_sessions_lyrics_latest_versions ON beat_sessions(user_id, lyrics_is_latest_version);
