  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-bold mb-2 font-display tracking-wider text-primary">Artist Dashboard</h1>
          <p className="text-xl text-gray-400">Welcome back, {user?.username || user?.email?.split('@')[0]}</p>
        </div>
      </div>
