...
import { Users, Music, BarChart, Settings, Music2, Timer, Package, Library, CreditCard, Sparkles, DollarSign } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-black border-primary hover:border-primary transition-all">
            <CardHeader>
              ...
              <CardDescription>See estimated provider cost per generation and recent AI usage.</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/api-costs">
                <Button className="w-full gradient-button text-black font-medium hover:text-white">
